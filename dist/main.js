...
/* harmony default export */ __webpack_exports__["default"] = ({
  data() {
    return {
      task: '',
      notes: [{ id: uuid__WEBPACK_IMPORTED_MODULE_1___default.a.v4(), task: 'Learn Vue.js', editing: false }, { id: uuid__WEBPACK_IMPORTED_MODULE_1___default.a.v4(), task: 'Learn Desktop App with Vuido', editing: false }]
    };
  },
  methods: {
    addNote() {
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("Group", { attrs: { title: "Tasks", margined: "" } }, [
        _c(
          "Box",
          { attrs: { padded: "" } },
          [
            ...
            _vm._l(_vm.notes, function(note) {
              return _c(
                "Box",
                { key: note.id, attrs: { horizontal: "", padded: "" } },
                [
                  _c("Text", [_vm._v(_vm._s(note.task))]),
                  note.editing
                    ? _c("TextInput", {
                        attrs: { value: note.task },
                        on: {
                          input: function($event) {
                            _vm.$set(note, "task", $event)
                          }
                        }
                      })
                    : _vm._e(),
